...
// // export const HomeComponent = ({categ,setCateg}) => {
...
// //   const images = [
// //     { name: 'Peter,Spiderman', nam: 'Spiderman', src: img1, author: 'Stan Lee', likes: 430, views: 12.8,categ:'disco' },
...
// //     if (selectValue==="disco"){
// //       filterImages=[...images].filter((image) =>
        
// //             image.categ===selectValue
// //         )
// //     }
...
// //           <a id="a1" className={categ==="disco"?'active':''}onClick={()=>setCateg("Discover")} href="#discover" value="disco">
// //             Discover
// //           </a>
...
export const HomeComponent = () => {
  ...
  const images = [
    ...
    { name: 'Heman', nam: 'Heman', src: img3, author: 'Roger Sweet', likes: 654, views: 47, categ: 'Branding' },
    { name: 'Thor', nam: 'Thor', src: img4, author: 'Odin Loki', likes: 556, views: 62.2, categ: 'Illustration' },
    { name: 'Black Panther,tchala', nam: 'Black Panther', src: img5, author: 'Mike Robb', likes: 441, views: 45.9, categ: 'Mobile' },
    { name: 'Captain America,Steve rogers', nam: 'Captain America', src: img6, author: 'Mark Anto', likes: 390, views: 55, categ: 'Web Design' },
    { name: 'Ironman,tony stark', nam: 'Ironman', src: img7, author: 'Rick Reiler', likes: 619, views: 32.5, categ: 'Product Design' },
    { name: 'Keaneu Reeves,Jhon Wick', nam: 'Jhon Wick', src: img8, author: 'Harper Lee', likes: 670, views: 52.8, categ: 'Discover' },
    { name: 'Harry Potter,Daniel Radcliff', nam: 'Harry Potter', src: img9, author: 'Jane Rowling', likes: 643, views: 62.1, categ: 'Animation' },
    { name: 'Tyler Durden,Brad Pitt', nam: 'Tyler Durden', src: img10, author: 'Roger Mark', likes: 554, views: 57.9, categ: 'Branding' },
    { name: 'Joker', nam: 'Joker', src: img11, author: 'Artris Lian', likes: 586, views: 62.2, categ: 'Illustration' },
    { name: 'Adolf Hitler', nam: 'Adolf Hitler', src: img12, author: 'Mike Robb', likes: 641, views: 60.9, categ: 'Mobile' },
    { name: 'Wolverin,Logan', nam: 'Wolverin', src: img13, author: 'Mark Anto', likes: 290, views: 55.3, categ: 'Web Design' },
    { name: 'Mike Tyson', nam: 'Mike Tyson', src: img14, author: 'Rick Reiler', likes: 819, views: 76.9, categ: 'Product Design' },
    { name: 'Conor Mccregor,ufc champion', nam: 'Conor McCregor', src: img15, author: 'Khabibtm', likes: 819, views: 62.1, categ: 'Discover' },
    { name: 'Walter Hartwell White,Heisenberg', nam: 'Walter H. White', src: img16, author: 'K.A Jessee', likes: 750, views: 72.4, categ: 'Animation' },
    ...
    { name: 'Sherlock Holmes', nam: 'Sherlock Holmes', src: img19, author: 'Anto Juan', likes: 596, views: 69.2, categ: 'Mobile' }
  ];
...
//     { name: 'Wolverin,Logan', nam: 'Wolverin', src: img13, author: 'Mark Anto', likes: 290, views: 55.3, categ: 'Web Design' },
//     { name: 'Mike Tyson', nam: 'Mike Tyson', src: img14, author: 'Rick Reiler', likes: 819, views: 76.9, categ: 'Product Design' },
//     { name: 'Conor Mccregor,ufc champion', nam: 'Conor McCregor', src: img15, author: 'Khabib', likes: 819, views: 62.1, categ: 'Discover' },
//     { name: 'Walter Hartwell White,Heisenberg', nam: 'Walter H. White', src: img16, author: 'K.A Jessee', likes: 750, views: 72.4, categ: 'Animation' },
//     { name: 'Thomas Shelby,Tommy,Cillian Murphy', nam: 'Thomas Shelby', src: img17, author: 'Mark stue', likes: 743, views: 65.2, categ: 'Branding' },
//     { name: 'Professor,Sergio Marquina', nam: 'Sergio Marquina', src: img18, author: 'Rio Mark', likes: 754, views: 67, categ: 'Illustration' },
//     { name: 'Sherlock Holmes', nam: 'Sherlock Holmes', src: img19, author: 'Anto Juan', likes: 596, views: 69.2, categ: 'Mobile' }
...
//           </a>
//         </div>
//         <div className="dribbb">
//           <img className="dribbbleimg" src={dribbble} alt="Dribbble logo" />
//         </div>
